...
また、作成したマスクはPNG画像としてダウンロードでき、お使いのグラフィックソフトのスポイトツールで色を抽出して着彩にお使いいただけます。<br>
さらに、ガマットマスクを用いて制作したイラスト作品を投稿することも可能で、他のイラストレーターの皆様がどの色域で着彩を行なっているのか参考にすることもできます。

> [!caution]
> バックエンド機能（ログイン、作品閲覧・投稿、プロフィール関連など）は停止いたしました。<br>
> ガマットマスクの作成およびダウンロードは引き続きご利用いただけます。
...
<table>
  ...
  <tr>
    <td>他ユーザーが作成したマスクを使って着彩したい人向けの機能です。コピーしたマスクは、すぐにダウンロード・Myマスクに保存できます。</td>
    <td>マイページでは、自身の公開・下書き作品の確認、いいね・ブックマークした作品を確認できます。また、プロフィール設定が可能になります。</td>
  </tr>
</table>
